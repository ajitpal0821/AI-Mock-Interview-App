    ...
    return (
        <div className="flex flex-col w-full gap-8 py-5">
            <div className="flex items-center justify-between w-full gap-2">
                <CustomBreadCrumb
                    breadCrumbPage={interview?.position || "Interview Details"}
                    breadCrumbItems={[{ label: "Mock Interviews", link: "/generate" }]}
                />

                <Link to={`/generate/interview/${interviewId}/start`} className="text-sm text-muted-foreground hover:text-muted transition">
                    <Button size="sm" >Start<Sparkles></Sparkles></Button>
                </Link>
            </div>
